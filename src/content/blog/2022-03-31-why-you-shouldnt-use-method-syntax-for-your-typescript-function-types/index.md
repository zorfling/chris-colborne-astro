...
It's not all bad news - it _will_ correctly catch it if the type changes completely, for instance from a \`string\` to a \`number\`, however I'd argue that that makes it even more insidious, sometimes it catches it, sometimes it doesn't.
